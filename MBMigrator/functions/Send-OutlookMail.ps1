Function Send-OutlookMail {
    <#
    .SYNOPSIS
        Creates and Sends a message using the local outlook client
    .DESCRIPTION
        Allows sending of mail message using the local outlook client rather than smtp or graph methods for sending mails in powershell
    .EXAMPLE
        Send-OutlookMail -Subject "Test message" -Body "Test email using Send-OutlookMail." -To admin@contoso.com
        Sends mail message to admin@contoso.com from local outlook client
    #>
