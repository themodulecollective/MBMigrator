function Export-MBMReport {
    <#
    .SYNOPSIS
        Exports data from MBM Migration Database to Microsoft Excel Report File
    .DESCRIPTION
        Exports data from MBM Migration Database to a basic or compound excel spreadsheet depending on the specified report. Common uses include identifying double mailboxes and delegate reporting.
    .EXAMPLE
        Export-MBMReport -Report MigrationWaveList -OutputFolderPath "C:\Users\UserName\Documents"
        The example exports the current Migration Wave List to the users Documents folder
    #>
